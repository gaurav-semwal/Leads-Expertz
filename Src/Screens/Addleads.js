...
import { Addleadsform, sourceapi, getstateapi, getcityapi, typeapi, categoryapi, subcategoryapi, classificationapi, campignsapi, projectapi } from '../Service/Apis';
...
const Addleads = ({ navigation }) => {
    ...
    const handleaddleads = async () => {
        console.log( fullname,
            ...
            comments)
        try {
          const response = await Addleadsform(
            fullname,
            email,
            mobilenumner,
            selectedSource,
